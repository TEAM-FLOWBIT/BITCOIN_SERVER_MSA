pipeline {
    ...
    environment {
        ...
        REPOSITORY_URL= 'https://github.com/TEAM-FLOWBIT/BITCOIN_SERVER_MSA.git'
        //docker-hub
        registryCredential = 'docker-hub'
        CONTAINER_NAME = 'flowbit-bitcoinservice'
        IMAGE_NAME = 'kimminwoo1234/flowbit-bitcoinservice'
    }
    ...
    stages {
        ...
        stage('Prepare') {
            steps {
                ...
                git branch: 'develop',
                    url: 'https://github.com/TEAM-FLOWBIT/BITCOIN_SERVER_MSA.git'
            }
            post {
                success {
        ...
        stage('Build Docker') {
            steps {
                echo 'Build Docker'
                sh """
                    cd /var/jenkins_home/workspace/flowbit-bitcoinservice
